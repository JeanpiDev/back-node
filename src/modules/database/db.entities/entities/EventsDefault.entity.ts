...
@Index("events_default_device_date_hour_idx", ["deviceDateHour"], {})
@Index("events_default_pkey", ["deviceDateHour", "id"], { unique: true })
@Index("events_default_event_type_id_idx", ["eventTypeId"], {})
@Index("events_default_unity_id_idx", ["unityId"], {})
@Entity("events_default", { schema: "public" })
export class EventsDefault {
