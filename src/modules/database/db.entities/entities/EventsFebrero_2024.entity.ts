...
@Index("events_febrero_2024_pkey", ["deviceDateHour", "id"], { unique: true })
@Index("events_febrero_2024_device_date_hour_idx", ["deviceDateHour"], {})
@Index("events_febrero_2024_event_type_id_idx", ["eventTypeId"], {})
@Index("events_febrero_2024_id_driver_idx", ["idDriver"], {})
@Index("events_febrero_2024_unity_id_idx", ["unityId"], {})
@Entity("events_febrero_2024", { schema: "public" })
export class EventsFebrero_2024 {
