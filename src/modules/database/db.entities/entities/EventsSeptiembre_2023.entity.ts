...
@Index("events_septiembre_2023_pkey", ["deviceDateHour", "id"], {
  unique: true,
})
@Index("events_septiembre_2023_device_date_hour_idx", ["deviceDateHour"], {})
@Index("events_septiembre_2023_event_type_id_idx", ["eventTypeId"], {})
@Index("events_septiembre_2023_unity_id_idx", ["unityId"], {})
@Entity("events_septiembre_2023", { schema: "public" })
export class EventsSeptiembre_2023 {
