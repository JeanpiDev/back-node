...
@Index("events_enero_2023_pkey", ["deviceDateHour", "id"], { unique: true })
@Index("events_enero_2023_device_date_hour_idx", ["deviceDateHour"], {})
@Index("events_enero_2023_event_type_id_idx", ["eventTypeId"], {})
@Index("events_enero_2023_unity_id_idx", ["unityId"], {})
@Entity("events_enero_2023", { schema: "public" })
export class EventsEnero_2023 {
